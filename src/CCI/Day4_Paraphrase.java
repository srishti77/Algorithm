...
public class Day4_Paraphrase {
	...
	public static void main(String args[]) {
		...
		*/
		Day4_Paraphrase day4 = new Day4_Paraphrase();
		try {
			
			FileInputStream file = new FileInputStream("C:\\Users\\User\\eclipse-workspace\\Algorithm\\src\\inputfile.txt");
			...
			while((singleline = br.readLine()) != null) {
				...
				for(int i = 0 ; i< stringArray.length; i++) {
					...
					for(int j = i+1; j< stringArray.length;j++) {
						if((stringArray[i].equals(stringArray[j]) ) || day4.checkAnagram(stringArray[i], stringArray[j] ))
							{
							flag = true;
			...
			System.out.println("cannopt read");
		}
		
		
		System.out.println(day4.checkAnagram("iioi", "iiio"));
	...
	public boolean checkAnagram(String str1, String str2) {
		...
		String newStr1 = new String(string1);
		String newStr2 = new String(string2);
