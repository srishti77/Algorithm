...
public class C4_CheckSubtree {
	...
	public static void main(String s[]) {
		...
		System.out.println("Exist: " + subtree.checkDescend(tree1.root, tree2.root));
	}
	...
	public boolean checkDescend(BSTree node1, BSTree node2) {
		...
		System.out.println("Compare Trees: " + node1.data + " " + node2.data);
		if (node1 != null && node1.data == node2.data && compareTrees(node1, node2)) {
			System.out.println("Compare Trees: " + node1.data + " " + node2.data);
			return true;
		}
